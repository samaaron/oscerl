...
%% Time-stamp: <2016-10-04 18:10:30 joearmstrong>
...
spawn_monitor1(Term, Parent) ->
	...
	{'EXIT', Parent, Why} ->
	    io:format("process:~p dies at:~p ~p reason:~p~n",
		      [self(), erlang:timestamp(), Term, Why])
    end.
...
%% If the environment variable is not defined an exception is raised
